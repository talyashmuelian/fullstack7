...
//     try {
//       const response = await requestsGet("/future-queues"); // Replace with the appropriate API endpoint to fetch future queues
//       const data = await response.json();
//       setFutureQueues(data);
//     } catch (error) {
...
//     try {
//       const response = await requestsPost("/add-appointment", {
//         ...formData,
